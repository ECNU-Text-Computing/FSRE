...
class FewShotREFramework:
    ...
    def train(self,
        ...
        print("Start testing")
        acc = self.eval(model, B, N_for_eval, K, Q, test_iter, na_rate=na_rate, pair=pair, ckpt= './checkpoint/{}.pth.tar'.format(model_name))
            ...
            for it in range(eval_iter):
                if pair:
                    ...
                    if ckpt is None:
                        ...
                        logits, pred = model(support, query, rel_text, N, K, Q + Q * na_rate)
